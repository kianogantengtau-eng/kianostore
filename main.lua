...
--------------------------------------------------------------------------------
-- SETTING UNDERGROUND & PLATFORM (-10 STUD)
--------------------------------------------------------------------------------
...
--------------------------------------------------------------------------------
-- LOGIKA REALTIME INVENTARIS & TRACKING
--------------------------------------------------------------------------------
local function UpdateInventoryStats()
    ...
    -- Hitung item di Backpack DAN item yang sedang di-equip di Karakter
    scan(backpack)
    scan(character)
...
-- Fast Loop Refresh (Setiap 0.5 detik selalu sinkronkan UI)
task.spawn(function()
    while true do
